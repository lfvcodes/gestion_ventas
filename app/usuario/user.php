      ...
      $('#tbl-user').DataTable({
        ...
        "drawCallback": function(settings) {
          $('#tbl-user tbody tr').each(function() {
            ...
            switch (str) {
              case "1":
                $(this).find('td:eq(3)').html('<span class="avatar-initial rounded bg-label-danger p-2">Administrador</span>');
                break;
              case "2":
                $(this).find('td:eq(3)').html('<span class="avatar-initial rounded bg-label-secondary p-2">Operador</span>');
                break;
              default:
                break;
            }
